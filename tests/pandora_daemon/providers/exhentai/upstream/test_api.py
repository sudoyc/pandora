...
from pandora_daemon.providers.exhentai.upstream.models.gallery import GalleryListItem, GalleryDetail
from pandora_daemon.providers.exhentai.upstream.constants import BASE_URL
...
async def test_parser_failure_raises_sanitized_parse_error():
    ...
    with patch(
        "pandora_daemon.providers.exhentai.upstream.api.parse_gallery_list",
