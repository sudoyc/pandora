...
class TestGetHome:
    def test_get_home_returns_200_and_correct_fields(self):
        ...
        mock_api.get_home_detail = AsyncMock(return_value=detail)
        ...
        mock_api.get_home_detail.assert_called_once()

    def test_get_home_calls_api(self):
        mock_api = MagicMock()
        mock_api.get_home_detail = AsyncMock(return_value=_make_home_detail())
        ...
        mock_api.get_home_detail.assert_called_once_with()
...
class TestResetLimit:
    def test_reset_limit_returns_200_and_home_fields(self):
        ...
        mock_api.reset_image_limit = AsyncMock(return_value=detail)
        ...
        assert data["image_total"] == 5000
        assert data["reset_cost"] == 50
        mock_api.reset_image_limit.assert_called_once()

    def test_reset_limit_calls_reset_image_limit(self):
        mock_api = MagicMock()
        mock_api.reset_image_limit = AsyncMock(return_value=_make_home_detail())
        ...
        mock_api.reset_image_limit.assert_called_once_with()
...
class TestGetProfile:
    ...
    def test_get_profile_calls_api(self):
        mock_api = MagicMock()
        mock_api.get_profile = AsyncMock(return_value=_make_profile())
        ...
        mock_api.get_profile.assert_called_once_with()
...
class TestGetTags:
    def test_get_tags_returns_200_with_tag_list(self):
        ...
        mock_api.get_mytags = AsyncMock(return_value=[tag])
    ...
    def test_get_tags_returns_empty_list(self):
        mock_api = MagicMock()
        mock_api.get_mytags = AsyncMock(return_value=[])
        ...
        mock_api.get_mytags.assert_called_once_with()


class TestAddTag:
    def test_add_tag_returns_ok(self):
        mock_api = MagicMock()
        mock_api.add_tag = AsyncMock(return_value=None)
    ...
    def test_add_tag_calls_api_with_correct_args(self):
        mock_api = MagicMock()
        mock_api.add_tag = AsyncMock(return_value=None)
        ...
        mock_api.add_tag.assert_called_once_with(
            "parody:bleach",
            watched=False,
            hidden=True,
            color="#aabbcc",
...
class TestDeleteTag:
    def test_delete_tag_returns_ok(self):
        mock_api = MagicMock()
        mock_api.delete_tag = AsyncMock(return_value=None)
    ...
    def test_delete_tag_calls_api_with_tag_id(self):
        mock_api = MagicMock()
        mock_api.delete_tag = AsyncMock(return_value=None)
        ...
        mock_api.delete_tag.assert_called_once_with(42)
    ...
    def test_delete_tag_passes_correct_id(self):
        ...
        mock_api.delete_tag.assert_called_once_with(99)
