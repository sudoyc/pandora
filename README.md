...
- `~/code/project/Ehviewer_CN_SXJ/workspace/docs/api_reference.md`: Formal API documentation is available for all completed endpoints.
- `~/code/project/Ehviewer_CN_SXJ/workspace/tui.py`: Functional 3-pane TUI layout prototype (to be integrated with new API).
- `~/code/project/Ehviewer_CN_SXJ/workspace/cli.py`: Command line interface to verify access, search galleries, list favorites, and download.
- `~/code/project/Ehviewer_CN_SXJ/workspace/downloader.py`: CLI script for full gallery downloads, supports pagination and async downloads.

## Next Steps
- Implement keyword search filtering on Favorites endpoint (`get_favorites`).
