...
Allowed examples: `health --json`, `config --json`, `readiness --json`, `status --json`, `search --json`, `popular --json`, `toplist --json`, `watched --json`, `gallery --json`, `tags status --json`, `tags suggest --json`, `library list --json`, and `favorites list --json`.
