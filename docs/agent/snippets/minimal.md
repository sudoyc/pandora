...
Do not import provider adapters, access upstream services directly, persist credentials or session data, create a second state layer, or parse human CLI output when machine output exists.
```
