...
|---|---|
| Program | In Progress |
| Active work package | `UP-04` |
| Next work package | None |
| Last completed work package | `UP-03` |
| Blockers | None |
| Source baseline | `fdca102`; 2026-07-23 文档与运行盘点 |
| Last full Python evidence | 571 passed（2026-07-24；GitHub Actions `30098470051`） |
| Last Web evidence | lint/build passed（2026-07-24；GitHub Actions `30098470051`） |
...
| `UP-04` | Yes | In Progress | `UP-03` | 部署和 Agent bootstrap 使用统一诊断顺序 | fixture daemon smoke、deployment/Agent Pack/skill 同步 |
