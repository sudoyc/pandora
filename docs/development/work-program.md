...
| Next work package | `CT-01` |
| Last completed work package | `DL-04` |
| Blockers | None |
| Source baseline | `fdca102`; 2026-07-23 文档与运行盘点 |
| Last full Python evidence | 626 passed（2026-07-25；本地统一检查，implementation `9ce9592`） |
| Last Web evidence | lint/build passed（2026-07-25；本地统一检查，implementation `9ce9592`） |
...
| `CT-01` | Yes | Ready | `UP-04`, `DL-04` | 定义 REST/CLI/WS 版本兼容、错误码、退出码和弃用策略 | 决策/contract 文档、错误矩阵 contract tests |
