...
| Last completed work package | `BUG-20260725-03` |
...
| `REL-02` | Yes | In Progress | `DIST-02`, `BUG-20260725-03` | 经人工放行后创建内部 tag/release，版本、tag 和 artifact 完全一致 | 远端 tag/release、artifact 校验和、安装 smoke、回滚点 |
