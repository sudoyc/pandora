...
| Last full Python evidence | 669 passed（2026-07-25；本地统一检查，implementation `73279c3`） |
| Last Web evidence | lint/build passed（2026-07-25；本地统一检查，implementation `73279c3`） |
