...
| Next work package | `UP-04` |
| Last completed work package | `UP-03` |
| Blockers | None |
| Source baseline | `fdca102`; 2026-07-23 文档与运行盘点 |
| Last full Python evidence | 571 passed（2026-07-24；本地统一检查，implementation `6752bdf`） |
| Last Web evidence | lint/build passed（2026-07-24；本地统一检查，implementation `6752bdf`） |
...
| `UP-04` | Yes | Ready | `UP-03` | 部署和 Agent bootstrap 使用统一诊断顺序 | fixture daemon smoke、deployment/Agent Pack/skill 同步 |
